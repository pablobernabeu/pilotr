...
develops open, reproducible research software in R and Python, and is a certified Carpentries
Instructor. pilotr grows out of that work and its predecessor, the *Experimental-data-simulation*
Shiny app (Bernabeu & Lynott, 2024). He is on
[ORCID](https://orcid.org/0000-0003-1083-2460) and [GitHub](https://github.com/pablobernabeu).
