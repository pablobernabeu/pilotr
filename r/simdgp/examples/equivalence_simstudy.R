...
# competitor. simstudy specifies outcomes through a formula + link function; simdgp through
...
# ---- Gaussian: simstudy formula "97.5 + 5*grp" vs simdgp intercept 100 + effect 5 ----
...
cat("=== Gaussian 2-group (simstudy formula+normal  vs  simdgp intercept+effect) ===\n")
cat("  statistic                 simstudy      simdgp\n  ------------------------------------------------\n")
...
# ---- Poisson / log link: simstudy link='log' vs simdgp poisson family ----
...
cat("\n=== Poisson, log link (simstudy  vs  simdgp) ===\n")
cat("  statistic                 simstudy      simdgp\n  ------------------------------------------------\n")
...
cat("\n=> simdgp matches simstudy's generative output; it adds a Python implementation,\n")
