...
and Type M errors, together with a power curve over sample size. 'R script' emits a
self-contained, reproducible R script, which the installed app can also verify by running it in
a clean R session and confirming bit-for-bit reproduction.
