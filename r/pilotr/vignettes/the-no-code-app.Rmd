...
Python with `pilotr.simulate()` for identical data. Crossed mixed-effects power runs in the
installed packages rather than in the browser (in R via `lme4`, the reference backend), and
precision/ROPE design analysis runs in the R package. Whichever interface you use, the
