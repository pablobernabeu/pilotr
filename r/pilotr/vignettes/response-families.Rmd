...
Behavioral outcomes are seldom Gaussian. pilotr maps the linear predictor
...
Binary accuracy is modeled through a logit link. The intercept is the log-odds of a correct
...
Bounded proportions in (0, 1) are modeled through a mean–precision parameterization. The mean
