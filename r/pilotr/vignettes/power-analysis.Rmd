...
```{r, eval = FALSE}
# tiny for the vignette; use >= 200 in practice
...
ggplot(curve, aes(n_subject, power)) +
  ...
  # canvas, both surfaces have to be cleared for the page colour to reach the
  # figure. The ink is left at its default: the website inverts the figure in
  # dark mode, which turns the dark axis text light, whereas a fixed mid-grey
  # would be inverted into a muddy tan.
...
power estimate over its converged replicates widened to a 95% envelope.
