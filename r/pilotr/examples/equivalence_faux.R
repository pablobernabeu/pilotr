...
#
# faux specifies a within-subject design through a correlation matrix; pilotr induces the
...
cat("  statistic              target      faux     pilotr\n")
cat("  ---------------------------------------------------\n")
...
cat("\n  => pilotr reproduces faux's correlated within-subject data. What pilotr ADDS:\n")
