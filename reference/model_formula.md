...
structure of a specification. Interaction coefficients written \`a:b\`
become formula terms \`a_b\`.
...
A \[stats::formula\] object suitable for fitting with \`lme4\` or
\`lmerTest\`.
