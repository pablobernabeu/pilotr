...
interfaces, namely a no-code web app, this R package and a [Python
package](https://pablobernabeu.github.io/pilotr/py/); given the same
specification and seed, all three produce bit-identical data.
...
required and no data uploaded. It is available as a [live
demo](https://pablobernabeu.github.io/pilotr/demo/).

## Learn more

This is the R package’s documentation; the companion Python package
mirrors it exactly and produces identical data from the same
specification. The full repository, including the specification format
and the no-code app, is at <https://github.com/pablobernabeu/pilotr>.
